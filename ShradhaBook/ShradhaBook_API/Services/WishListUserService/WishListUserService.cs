...
//        public async Task<int> AddWishListUserAsync(WishListProductPost model)
//        {
...
//                return MyStatusCode.DUPLICATE;
//            }
//            WishListProductPost  modelPost = new WishListUserPost(0, userId, wishList.Id, null, null);
...
//        public async Task<List<WishListProductGet>> GetAllWishListUserAsync()
//        {
...
//                return null;
//            }
//            return _mapper.Map<List<WishListProductGet>>(models);
//        }



//        public Task<List<WishListProductGet>> GetAllWishListUserAsync(int pageSize = 20, int pageIndex = 1)
//        {
...
//        public async  Task<WishListProductGet> GetWishListUserAsync(int id)
//        {
...
//                return null;
//            }
//            return _mapper.Map<WishListProductGet>(models[0]);
//        }



//        public async Task<List<WishListProductGet>> GetWishListUsersByUserIdAsync(int id)
//        {
...
//        public async  Task<int> UpdateWishListUserAsync(int id, WishListProductPost model)
//        {
