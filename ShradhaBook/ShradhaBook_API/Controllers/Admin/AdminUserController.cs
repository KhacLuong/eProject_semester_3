...
namespace ShradhaBook_API.Controllers.Admin
{
    ...
    public class AdminUserController : ControllerBase
    {
        ...
        public async Task<IActionResult> ForgotPassword(string email)
        {
            ...
            if (token is null)
                return NotFound(new ServiceResponse<string> { Status = false, Message = "Email address has not been register." });
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordRequest request)
        {
            ...
            if (message is null)
                return BadRequest(new ServiceResponse<string> { Status = false, Message = "Invalid Token or Token has been expired" });
